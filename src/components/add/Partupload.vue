...
const emits = defineEmits(['imgUpload', 'imgRemove'])
...
const handleRemove = (file: any) => {
  myfileList.value = myfileList.value.filter((item: any) => item.uid !== file.uid)
  emits('imgRemove', file)
}
